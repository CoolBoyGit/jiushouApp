...
-(UIButton *)anonymatCommemtButton{
    if (_anonymatCommemtButton==nil) {
        ...
        _anonymatCommemtButton.titleLabel.font = [UIFont systemFontOfSize:14];
...
-(UIButton*)button{
    if (_button==nil) {
        ...
        _button.frame = CGRectMake(ScreenWidth-100, 0, 100, 49);
...
-(void)btnClick1:(UIButton *)btn
{
    ...
    for (EvaluationGoodsInfo *info in self.evaluationRequest.evaluationItems) {
        info.is_anonymous = btn.isSelected ? @1 : @0;
    }
}
@end
