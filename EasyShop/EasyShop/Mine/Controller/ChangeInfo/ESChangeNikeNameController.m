...
-(UITextField *)nikeTextField{
    if (_nikeTextField==nil) {
        ...
        _nikeTextField. leftViewMode       = UITextFieldViewModeAlways;
        _nikeTextField.leftView=whiteView;
