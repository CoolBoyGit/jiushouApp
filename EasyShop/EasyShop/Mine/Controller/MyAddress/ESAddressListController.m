...
@property (nonatomic,strong) ESAddressListTipsView*addressTipView;
@end
...
-(ESAddressListTipsView *)addressTipView{
    if (_addressTipView==nil) {
        _addressTipView=[[ESAddressListTipsView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, 50)];
    }
    return _addressTipView;
}
...
- (void)viewDidLoad
{
    ...
    self.tableView.tableFooterView=self.addressTipView;
    
//    self.tableView.tableFooterView=({
//        self.addressTipView=[[ESAddressListTipsView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, 50)];
//        self.addressTipView;
    //});
