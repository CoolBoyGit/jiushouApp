...
- (void)setupViews
{
    self.shopImg.image = [UIImage imageNamed:@"bg"];
...
- (UIButton *)remindButton
{
    if (!_remindButton) {
        ...
        _remindButton.titleLabel.font = [UIFont systemFontOfSize:15];
        ...
        [_remindButton setBackgroundColor:RGB(233, 40, 46)];
