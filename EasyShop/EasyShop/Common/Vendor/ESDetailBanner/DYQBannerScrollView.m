...
-(void)setup{
    self.timeInterval = 2;
    self.placeholderImage = [UIImage imageNamed:@"bg414*414"];
    self.noDataPlaceholderImage = [UIImage imageNamed:@"bg414*414"];
    ...
    _pageControl.currentPageIndicatorTintColor = RGB(233, 40, 46);
