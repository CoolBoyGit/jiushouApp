...
//#import "ADeanAppDelegate+EaseMobDebug.h"
...
#warning SDK注册 APNS文件的名字, 需要与后台上传证书时的名字一一对应
    ...
    [[EaseMob sharedInstance] registerSDKWithAppKey:@"9144070333488001xw#easyshopjiushouguojicom"
                                                apnsCertName:apnsCertName
                                        otherConfig:@{kSDKConfigEnableConsoleLogger:@YES}];
    
//    [[EaseMob sharedInstance] registerSDKWithAppKey:@"4009696811#beiyunbang" apnsCertName:@"user_production"];
...
//        alertView.tag = 100;
        [alertView show];
        //[self didRemovedFromServer];
        
    } onQueue:nil];
    
      [[NSNotificationCenter defaultCenter] postNotificationName:@"cancelLogin" object:self];
}

- (void)didReceiveMessage:(EMMessage *)message
{
     UINavigationController*nav = self.tabbarController.viewControllers[0];
    ESPageController*vc =nav.childViewControllers[0];
