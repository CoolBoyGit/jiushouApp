...
+(NSURLSessionTask *)GetAllOrderCountRequest:(GetAllOrderCount *)request
                                     ...
                                     failure:(FailureBlock)failure;
/** 11.10 获取退款结果详情 */
+(NSURLSessionTask *)GetRefundResultRequest:(GetRefundResultRequest *)request
                                    success:(void(^)(RefundResultRespone *refund))success
                                    failure:(FailureBlock)failure;
...
/**/
//weiin
+ (NSURLSessionTask *)joinWeixinClusterRequest:(JoinClusterRequest *)request
                                       success:(void (^)(WeixinPayAllInfo *response))success
                                       failure:(FailureBlock)failure;
...
//创团支付支付宝
+ (NSURLSessionTask *)createClusterRequest:(CreateClusterRequest *)request
                                   success:(void (^)(NSString *response))success
                                   failure:(FailureBlock)failure;

//创团支付微信

+ (NSURLSessionTask *)createWeixinClusterRequest:(CreateClusterRequest *)request
                                   success:(void (^)(WeixinPayAllInfo *response))success
                                   failure:(FailureBlock)failure;
...
+ (NSURLSessionTask *)getClusterSimpleGoodsRequest:(GetSimpGoodsRequest *)request
                                           success:(void (^) (GetSimpGoodsRespone *respone))success
                                           failure:(FailureBlock)failure;
...
+ (NSURLSessionTask *)GetclusterCouponRequest:(GetclusterCouponRequest *)request
                                      success:(ArrayBlock)success
                                      failure:(FailureBlock)failure;
/**
 *  17.9 获取拼团面的商品
 */
+ (NSURLSessionTask *)GetClusterGoodsRequest:(GetClusterGoodsRequest *)request
                                     success:(ArrayBlock)success
                                     failure:(FailureBlock)failure;
@end
