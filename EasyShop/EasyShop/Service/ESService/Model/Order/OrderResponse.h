...
/** 税费 */
@property (nonatomic,strong) NSString *tax_fee;
/** 退款状态 **/
...
@property (nonatomic,copy) NSString *tax_cost;
@end
...
@end
/** 查看退款申请的结果 */
@interface RefundResultRespone : NSObject
@property (nonatomic,copy) NSString*oid;
@property (nonatomic,copy) NSString*order_id;
...
@property (nonatomic,copy) NSString*refund_message;
@property (nonatomic,copy) NSString*apply_amount;
@property (nonatomic,copy) NSString*refund_amount;
@property (nonatomic,strong) NSNumber*apply_time;//这个是申请退款时间
@property (nonatomic,strong) NSNumber*refund_time;//退款成功时间
@property (nonatomic,strong) NSNumber*refund_status;
@property (nonatomic,strong) NSString*apply_rmb_amount;//支付宝才有这两个字段
@property (nonatomic,strong) NSString*refund_rmb_amount;//支付宝才有这两个字段
@end
