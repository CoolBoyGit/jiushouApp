...
#pragma mark 设置底部按钮的颜色
    _toolbar.tintColor = [UIColor colorWithRed:233/255.0 green:40/255.0 blue:46/255.0 alpha:1];
...
- (void)performLayout {
    ...
    // Left button - Grid 放置的是左边的显示九宫格的按钮
    if (_enableGrid) {
        hasItems = YES;
...
#pragma mark 设置返回按钮的颜色
    navBar.barTintColor=[UIColor whiteColor];
    navBar.tintColor = [UIColor colorWithRed:70/255.0 green:70/255.0 blue:70/255.0 alpha:1];
    [navBar setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithRed:70/255.0 green:70/255.0 blue:70/255.0 alpha:1],NSFontAttributeName:[UIFont systemFontOfSize:17]}];
