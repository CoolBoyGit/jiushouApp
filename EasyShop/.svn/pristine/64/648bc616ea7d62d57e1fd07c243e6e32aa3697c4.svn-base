...
//    self.frame = CGRectMake(toolViewX, toolViewY, toolViewW, toolViewH);
    ...
    self.backgroundColor=[UIColor colorWithWhite:0.902 alpha:0.5];
//    self.frame = CGRectMake(toolViewX, toolViewY, ScreenWidth, toolViewH);
    self.frame=CGRectMake(toolViewX, 0, ScreenWidth, ScreenHeight);
}
-(void)tapAction{
    [self remove];
}
-(void)setUpPickView{
   ...
   // pickView.frame=CGRectMake(0, ZHToobarHeight, ScreenWidth, pickView.frame.size.height);
    pickView.frame=CGRectMake(0, ScreenHeight-200, ScreenWidth, 200);
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    //datePicker.frame=CGRectMake(0, 0, ScreenWidth, 100);
    ...
    datePicker.frame=CGRectMake(0, ScreenHeight-200, ScreenWidth, 200);
...
-(void)setToolbarWithPickViewFrame{
    _toolbar.frame=CGRectMake(0, ScreenHeight-240,[UIScreen mainScreen].bounds.size.width, ZHToobarHeight);
}
